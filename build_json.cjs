...
const viewers = [
  ...
  { file: 'zhanna-tarasevich-nalogoviy-inspektor-bobruysk.png', name: 'Жанна Тарасевич', job: 'Налоговый инспектор', city: 'Бобруйск', qId: 50 },
  { file: 'darima-tsyrenova-provodnitsa-ulan-ude.png', name: 'Дарима Цыренова', job: 'Проводница', city: 'Улан-Удэ', qId: 55 },
  { file: 'oksana-marchenko-bufetchitsa-yalta.png', name: 'Оксана Марченко', job: 'Буфетчица', city: 'Ялта', qId: 53 },
  { file: 'aurika-rotaru-sekretar-referent-kishinev.png', name: 'Аурика Ротару', job: 'Секретарь-референт', city: 'Кишинев', qId: 42 },
  { file: 'inessa-shevchenko-buhgalter-dnepropetrovsk.png', name: 'Инесса Шевченко', job: 'Бухгалтер', city: 'Днепропетровск', qId: 44 },
  { file: 'tiina-kallas-arhivist-tartu.png', name: 'Тийна Каллас', job: 'Архивист', city: 'Тарту', qId: 47 },
  { file: 'stepan-chernomorets-vodolaz-anapa.png', name: 'Степан Черноморец', job: 'Водолаз', city: 'Анапа', qId: 45 },
  { file: 'armen-ghazaryan-taksist-gyumri.png', name: 'Армен Казарян', job: 'Таксист', city: 'Гюмри', qId: 46 },
  { file: 'bogdan-kovalenko-kraeved-kharkov.png', name: 'Богдан Коваленко', job: 'Краевед', city: 'Харьков', qId: 48 },
  { file: 'rinat-safin-gidrolog-astrakhan.png', name: 'Ринат Сафин', job: 'Гидролог', city: 'Астрахань', qId: 43 },
  { file: 'ilya-zverev-rukovoditel-kruzhka-rybinsk.png', name: 'Илья Зверев', job: 'Руководитель кружка', city: 'Рыбинск', qId: 41 },
  { file: 'nyurgun-dyakonov-trener-dzudo-yakutsk.png', name: 'Нюргун Дьяконов', job: 'Тренер по дзюдо', city: 'Якутск', qId: 40 },
  { file: 'serik-akhmetov-prorab-karaganda.png', name: 'Серик Ахметов', job: 'Прораб', city: 'Караганда', qId: 54 },
  { file: 'stanislav-volkov-voenruk-sevastopol.png', name: 'Станислав Волков', job: 'Военрук', city: 'Севастополь', qId: 49 },
  { file: 'taras-bondarenko-smotritel-zooparka-nikolaev.png', name: 'Тарас Бондаренко', job: 'Смотритель зоопарка', city: 'Николаев', qId: 51 },
  { file: 'timur-isaev-voditel-marshrutki-grozny.png', name: 'Тимур Исаев', job: 'Водитель маршрутки', city: 'Грозный', qId: 52 },
